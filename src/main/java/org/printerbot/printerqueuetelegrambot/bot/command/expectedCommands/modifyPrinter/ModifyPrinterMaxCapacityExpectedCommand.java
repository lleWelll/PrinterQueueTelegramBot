...
@Slf4j
public class ModifyPrinterMaxCapacityExpectedCommand implements ExpectedCommand {
	...
	public SendMessage apply(Update update) {
		...
		try {
			...
			printerDaoService.updateEntity(printer.getId(), (e) -> e.setMaxPlasticCapacity(max));
		} catch (PrinterNotFoundException | IllegalArgumentException e) {

...
@Slf4j
public class ModifyPrinterRemoveSupportedPlastic implements ExpectedCommand {
	...
	public SendMessage apply(Update update) {
		...
		try {
			...
			printerDaoService.updateEntity(printer.getId(), (e) -> e.removePlastic(plasticEntityList));
		} catch (Exception e) {
